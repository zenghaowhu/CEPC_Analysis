...
#ifndef MCPFASTJETPROCESSOR_H_
#define MCPFASTJETPROCESSOR_H_
...
class MCPFastJetProcessor : Processor
{
public:
	MCPFastJetProcessor();
    virtual ~MCPFastJetProcessor();

	virtual Processor* newProcessor()
	{
		return new MCPFastJetProcessor();
	}
