#ifndef _MCPnngamma_hh_
#define _MCPnngamma_hh_
...
class MCPnngamma  : public marlin::Processor
{
	public:

		Processor*  newProcessor() { return new MCPnngamma ; }
...
//		TFile *tree_file;
    ...
    double MCP_energy[100], MCP_costheta[100];
    double Reco_energy[100], Reco_costheta[100];
    int Rgamma_size;
    int gamma_size;
